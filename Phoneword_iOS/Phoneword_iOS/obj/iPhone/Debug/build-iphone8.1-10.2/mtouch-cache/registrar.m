...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "Phoneword_iOS.AppDelegate, Phoneword_iOS", "get_Window");
	}

	-(void) setWindow:(UIWindow *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS", "Phoneword_iOS.AppDelegate, Phoneword_iOS", "set_Window");
	}

	-(BOOL) application:(UIApplication *)p0 didFinishLaunchingWithOptions:(NSDictionary *)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "Phoneword_iOS.AppDelegate, Phoneword_iOS", "FinishedLaunching");
	}

	-(void) applicationWillResignActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "Phoneword_iOS.AppDelegate, Phoneword_iOS", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "Phoneword_iOS.AppDelegate, Phoneword_iOS", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "Phoneword_iOS.AppDelegate, Phoneword_iOS", "WillEnterForeground");
	}

	-(void) applicationDidBecomeActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "Phoneword_iOS.AppDelegate, Phoneword_iOS", "OnActivated");
	}

	-(void) applicationWillTerminate:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "Phoneword_iOS.AppDelegate, Phoneword_iOS", "WillTerminate");
	}
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_7 (self, _cmd, &managed_method, "Phoneword_iOS.AppDelegate, Phoneword_iOS", ".ctor", &call_super);
		if (call_super && rv) {
...
@implementation ViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, "Phoneword_iOS.ViewController, Phoneword_iOS", "get_CallButton");
	}

	-(void) setCallButton:(UIButton *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "Phoneword_iOS.ViewController, Phoneword_iOS", "set_CallButton");
	}

	-(UITextField *) PhoneNumberText
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_10 (self, _cmd, &managed_method, "Phoneword_iOS.ViewController, Phoneword_iOS", "get_PhoneNumberText");
	}

	-(void) setPhoneNumberText:(UITextField *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_11 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "Phoneword_iOS.ViewController, Phoneword_iOS", "set_PhoneNumberText");
	}

	-(UIButton *) TranslateButton
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, "Phoneword_iOS.ViewController, Phoneword_iOS", "get_TranslateButton");
	}

	-(void) setTranslateButton:(UIButton *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "Phoneword_iOS.ViewController, Phoneword_iOS", "set_TranslateButton");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "Phoneword_iOS.ViewController, Phoneword_iOS", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "Phoneword_iOS.ViewController, Phoneword_iOS", "DidReceiveMemoryWarning");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "Phoneword_iOS.AppDelegate, Phoneword_iOS", NULL },
		{"ViewController", "Phoneword_iOS.ViewController, Phoneword_iOS", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [9].handle = objc_getClass ("CKShareMetadata");
	...
	__xamarin_class_map [16].handle = objc_getClass ("UIKit_UIControlEventProxy");
	__xamarin_class_map [17].handle = objc_getClass ("UIDevice");
	__xamarin_class_map [18].handle = objc_getClass ("UITextField");
	__xamarin_class_map [19].handle = objc_getClass ("UITraitCollection");
	...
	__xamarin_class_map [24].handle = objc_getClass ("UIAlertAction");
	__xamarin_class_map [25].handle = objc_getClass ("UIAlertController");
	__xamarin_class_map [26].handle = objc_getClass ("UIApplicationShortcutItem");
	...
	__xamarin_class_map [30].handle = objc_getClass ("UIFocusUpdateContext");
	__xamarin_class_map [31].handle = objc_getClass ("UILocalNotification");
	__xamarin_class_map [32].handle = objc_getClass ("UITextPosition");
	__xamarin_class_map [33].handle = objc_getClass ("UITextRange");
